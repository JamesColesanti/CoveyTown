...
/**
 * Create a new whiteboard area using some random defaults
 * @param params
 * @returns
 */
export function createWhiteboardAreaForTesting(params: {
  areaID: string;
  canvas: undefined;
  comments: Comment[];
  gallery: GalleryCanvasModel[];
}): WhiteboardArea {
  return {
    id: params?.areaID || nanoid(),
